...
export const EQUIPMENT=[{id:'pan',name:'平底鍋',aliases:['平底鍋','炒鍋']},{id:'pot',name:'湯鍋',aliases:['湯鍋','煮鍋']},{id:'stove',name:'爐火',aliases:['爐火','瓦斯爐','電磁爐']},{id:'riceCooker',name:'電鍋',aliases:['電鍋']}];
